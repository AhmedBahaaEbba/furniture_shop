...
//import 'file:///E:/Flutter/Projects/furniture_shop/lib/furniture_ui/utils/constants.dart';
        ...
        child: AnimatedContainer(
          ...
          child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                  color: isEnable ? Colors.orange : Colors.white.withOpacity(0),
                  shape: BoxShape.circle),
              child: Opacity(
                opacity: isEnable ? _yController.value : 1,
                child:
                    Icon(icon, color: isEnable ? Colors.white : Colors.white),
              )),
        ),
      ),
    );
