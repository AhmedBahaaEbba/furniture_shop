...
class ProfilePage02 extends StatefulWidget {
  static const routeName = '/profile02';

  @override
  _ProfilePage02State createState() => _ProfilePage02State();
}

class _ProfilePage02State extends State<ProfilePage02> {
  ...
  void createListItem() {
    ...
    listSection.add(createSection("About Us", "images/ic_about_us.png",
        Colors.black.withOpacity(0.8), AboutUsPage()));
    listSection.add(createSection(
